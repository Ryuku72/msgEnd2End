...
export function BunLogo({ className = '', svgColor = 'none', id }: SVG_Component_props) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 70" fill={svgColor} id={id}>
      ...
      <g id="Face">
        <ellipse data-name="Right Blush" cx="53.22" cy="40.18" rx="5.85" ry="3.44" fill="#febbd0" />
        <ellipse data-name="Left Bluch" cx="22.95" cy="40.18" rx="5.85" ry="3.44" fill="#febbd0" />
        <path
