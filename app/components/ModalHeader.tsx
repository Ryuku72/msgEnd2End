...
export function ModalHeader({ title, close, invert = false }: ModalHeaderProps) {
  return (
    <div
      className={`w-full pt-4 px-6 pb-2 flex rounded-t-[inherit] justify-between items-center ${invert ? 'bg-black bg-opacity-75 text-white' : 'bg-white text-gray-600'}`}>
